...
| Metric | Baseline | HE-MOD Target | Rationale |
|--------|----------|---------------|-----------|
...
1. **RQ1:** Can Grad-CAM++ explanations be validated inside MOT pipelines?
2. **RQ2:** Do temporal explanation metrics correlate with tracking stability?
3. **RQ3:** Can explanation behavior predict identity switches/fragmentation?
4. **RQ4:** **Does integrated XAI-MOT maintain ≥20 FPS real-time?**

## 🔗 RESOURCES
- **Repository:** https://github.com/rvinodsarna/HE-MOD
- **TechRxiv:** DOI forthcoming (March 21, 2026 submission)
...
**First Publication: March 21, 2026 | 00:33 AM +08**
